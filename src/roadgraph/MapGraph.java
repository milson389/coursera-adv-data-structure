...
public class MapGraph {
	...
	private boolean dijkstraAlgorithm(MapNode startNode, MapNode endNode, PriorityQueue<MapNode> toExplore, HashSet<MapNode> visited,
	...
	private boolean aStarSearchHelper(MapNode startNode, MapNode endNode, PriorityQueue<MapNode> toExplore, HashSet<MapNode> visited,
									  HashMap<MapNode, MapNode> parentMap, Consumer<GeographicPoint> nodeSearched) {
			startNode.setDistance(0);
